...
insert into appuser (userid,username,password,role) values ('EMPLOYEE102','employee','employee','EMPLOYEE');
insert into appuser (userid,username,password,role) values ('EMPLOYEE103','employee','employee','EMPLOYEE');
insert into appuser (userid,username,password,role) values ('EMPLOYEE104','soniya','soniya','EMPLOYEE');
